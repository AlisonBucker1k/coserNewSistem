        ...
        <div class="page-info">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cadastrar Coordenador</li>
                </ol>
            </nav>
            ...
            <form method="POST">
                <div class="row">
                    <div class="col-xl">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Cadastrar Coordenador </h5>
                                <p>Area destinada ao cadastro de Coordenadores. </p>
