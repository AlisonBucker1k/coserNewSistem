...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title><?php echo $title;?> | Gerenciador Master</title>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="auth-form">
                            <div class="row">
                                <div class="col">
                                    <div class="logo-box"><a href="#" class="logo-text">Fazer Login</a></div>
                                    <form method="POST">
                                        <?php if(isset($error)):?>
                                            <div class="alert alert-danger">Email e/ou senha incorretos</div>
                                        <?php endif;?>
                                        ...
                                        <button type="submit" class="btn btn-danger btn-block btn-default" style="color: #fff !important;">Entrar</button>
                    ...
                    <div class="col-lg-6 d-none d-lg-block d-xl-block">
                        ...
                        <!-- <img src="<?php echo BASE_URL.'assets/images/logo-grande.png'?>" alt="" width="500px"> -->
                    </div>
                </div>
            </div>
        </div>
